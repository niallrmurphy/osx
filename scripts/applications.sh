...
MUNKI_APP_URL=https://github.com/munki/munki/releases/download/v3.6.4/munkitools-3.6.4.3786.pkg
MUNKI_APP_NAME=Munki
install_pkg "$MUNKI_APP_URL" "$MUNKI_APP_NAME"
